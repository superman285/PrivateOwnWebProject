...
function slideFunction(clickIndex, curIndex, modNum, imgul, control, controlColor, arrIdx, safeIndex) {
    ...
    function setImgPos() {
        ...
        imgul.eq(0).css("left",-900 * curIndex + "px");
    }
    ...
    function setControlPos() {
        ...
        control.map(idx=>{
            control.eq(idx).removeClass("active");
        });
        control.eq(dotIndex).addClass("active")
    }
    ...
    arrL.eq(arrIdx).click(function () {
        ...
        if (clickIndex % modNum === 0) {
            ...
            imgul.eq(0).css("left", -900 * (imgli.length - 1) + "px");
            clickIndex--;
        }
        setTimeout(function () {
            dotIndex = curIndex > 0 ? curIndex - 1 : 3;
